/**
 * The base box-shadow styles for the  React TSUI Dashboard PRO Material.
 * You can add new box-shadow using this file.
 * You can customized the box-shadow for the entire  React TSUI Dashboard PRO Material using thie file.
 */
