...
// export const BASE_URL: string = "https://doshdemo.onrender.com";
export const BASE_URL: string = "https://dosh-updated.onrender.com";
export const STRIP_PK: string =
  "pk_test_51NFZaOLLDUmTZxUmkDuDcasoN5JOWe1Q4aPJXUqqURoA9fd2cS4Vcx7rooYsmfivbLhojg1vM1uzegRpZ7MNl52700t9DowwUF";
export const STRIP_SK: string =
