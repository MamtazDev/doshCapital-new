...
// Data
import channelChartData from "layouts/dashboards/portfolio/components/ChannelsChart/data";
  ...
  return (
    <Card sx={{ height: "100%" }}>
      <MDBox display="flex" justifyContent="space-between" alignItems="center" pt={2} px={2}>
        <MDTypography variant="h6">Slice of the pie</MDTypography>
      ...
      <MDBox mt={3}>
        <Grid container alignItems="center">
          ...
          <Grid item xs={5}>
            <MDBox pr={1}>
              <MDBox mb={1}>
                <MDBadgeDot color="success" size="sm" badgeContent="ETF's" />
              </MDBox>
              <MDBox mb={1}>
                <MDBadgeDot color="info" size="sm" badgeContent="Cash" />
              </MDBox>
              <MDBox mb={1}>
              ...
              <MDBox mb={1}>
                <MDBadgeDot color="secondary" size="sm" badgeContent="Do$h Capital" />
              </MDBox>
            </MDBox>
          </Grid>
        </Grid>
